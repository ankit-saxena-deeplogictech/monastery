...
async function elementConnected(element) {
	Object.defineProperty(element, "value", {
		get: _ => JSON.stringify(item_list.getData(element.id).items),
		set: value => {
	...
	const data = {
		items: _addDBLClickHandlerToItems(JSON.parse(element.getAttribute("value") || "[]"), element.getAttribute("ondblclickHandler")),
