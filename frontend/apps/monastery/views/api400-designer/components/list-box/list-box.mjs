...
function addTextBox(element, value) {  
  ...
  const parentContainer = _getParentContainer(), inputElement = _createElement(parentContainer,listBoxElement.getAttribute("id"), value, listBoxElement.getAttribute("placeHolder"),"text-box","dynamic","text",listBoxElement.getAttribute("required"));
...
export const list_box = { trueWebComponentMode: false,elementConnected, elementRendered,removeElement,addMultipleTextBoxes,  addTextBox,
