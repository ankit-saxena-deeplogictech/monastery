...
const showMessage = (templatePath, data, hostID) => display_box.showDialog(templatePath, true, 
    false, data, hostID, [], _=> display_box.hideDialog("dialog"));
...
function _showDialogInternal(templateHTML, showOK, showCancel, hostID, retValIDs, callback) {
    ...
    const memory = display_box.getMemory(hostID); memory.retValIDs = retValIDs; memory.callback = callback;
...
export const display_box = {showDialog, trueWebComponentMode, hideDialog, error, showMessage, hideError, submit}
