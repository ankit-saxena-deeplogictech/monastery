...
const main = async (data, mainLoginAppModule) => {
    window.monkshu_env.apps[APP_CONSTANTS.EMBEDDED_APP_NAME] = {main: monasteryapp};
...
export const monasteryapp = {main, openView, gohome, onlogout, showMessage, showError};